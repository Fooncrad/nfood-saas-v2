...
const translations = {
  ar: {
    dir: 'rtl', projectName: 'NFOOD', panelTitle: 'لوحة الإدارة العليا', panelSubtitle: 'إدارة المنصة والمستخدمين والمتاجر والاشتراكات والإعدادات من مركز واحد', systemReady: 'النظام حي ومستقر', searchPlaceholder: 'ابحث عن متجر، مستخدم، إعداد... (Ctrl + K)', adminCenter: 'مركز التحكم', adminBadge: 'بوابة التحكم العليا',
  ...
  en: {
    dir: 'ltr', projectName: 'NFOOD Ecosystem', panelTitle: 'Central & Enterprise Admin', panelSubtitle: 'Manage the platform, users, stores, subscriptions and settings from one control center', systemReady: 'System Live & Stable', searchPlaceholder: 'Search stores, users, settings... (Ctrl + K)', adminCenter: 'Control Center', adminBadge: 'Master Control Gateway',
  ...
  fr: {
    dir: 'ltr', projectName: 'Écosystème NFOOD', panelTitle: 'Admin Central & Entreprise', panelSubtitle: 'Gérez la plateforme, les utilisateurs, les magasins, les abonnements et les paramètres', systemReady: 'Système En Ligne', searchPlaceholder: 'Rechercher magasins, utilisateurs, paramètres... (Ctrl + K)', adminCenter: 'Centre de Contrôle', adminBadge: 'Passerelle de Contrôle Maître',
