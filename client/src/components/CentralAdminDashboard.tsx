...
const translations = {
  ar: {
    dir: 'rtl', projectName: 'NFOOD', panelTitle: 'لوحة الإدارة العليا', panelSubtitle: 'إدارة المطاعم والمتاجر والاشتراكات والعمليات من مركز واحد', systemReady: 'النظام حي ومستقر', searchPlaceholder: 'ابحث عن متجر، مستخدم، إعداد... (Ctrl + K)', adminCenter: 'مركز التحكم', adminBadge: 'بوابة التحكم العليا',
  ...
  en: {
    dir: 'ltr', projectName: 'NFOOD Ecosystem', panelTitle: 'Central & Enterprise Admin', panelSubtitle: 'Instant feature toggles, business sector activation & subscription plan upgrades', systemReady: 'System Live & Stable', searchPlaceholder: 'Search stores, users, settings... (Ctrl + K)', adminCenter: 'Control Center', adminBadge: 'Master Control Gateway',
