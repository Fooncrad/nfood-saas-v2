...
export function LoyaltyPanel({ restaurantId }: { restaurantId: number }) {
  ...
  return <Card className="mt-5 rounded-2xl border-slate-200 bg-white shadow-sm" dir="rtl">
    <CardHeader className="pb-3"><CardTitle className="flex items-center gap-2 text-lg"><Gift className="h-5 w-5 text-[#e76f3c]" /> الولاء والإحالات</CardTitle><p className="text-sm text-slate-500">إدارة يدوية مرتبطة بالعميل والمطعم. لا يتم احتساب مكافأة تلقائية قبل تفعيل قواعد الأعمال.</p></CardHeader>
