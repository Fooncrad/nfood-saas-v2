  ...
  return (
    <div dir={direction} className="h-dvh overflow-hidden bg-[#f7f8fb] text-slate-900 transition-colors duration-300 dark:bg-slate-950 dark:text-white motion-safe:animate-[nfood-auth-slide-in_360ms_cubic-bezier(0.23,1,0.32,1)]">
      <div className="mx-auto grid h-full min-h-0 max-w-6xl lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <main className="nfood-scroll-area min-h-0 overflow-y-auto overflow-x-hidden flex items-start justify-center p-3 sm:items-center sm:p-5">
          <div className="fixed right-5 top-5 z-20"><LanguageSwitcher compact /></div>
          <Card className="my-1 min-h-[calc(100dvh-2rem)] max-h-[calc(100dvh-1.5rem)] w-full max-w-2xl overflow-hidden rounded-[1.5rem] sm:my-0 sm:rounded-[2rem] border border-white/70 bg-white/60 shadow-[0_24px_80px_rgba(15,23,42,0.12)] backdrop-blur-2xl transition-colors duration-300 dark:border-white/10 dark:bg-slate-900/60">
            <CardContent className="nfood-scroll-area h-full overflow-y-auto p-3 sm:p-5 lg:[zoom:0.72]">
