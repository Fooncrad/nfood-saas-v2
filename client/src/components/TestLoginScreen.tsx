...
export function TestLoginScreen({
  ...
  return (
    <div dir={direction} className="nfood-auth-shell h-[100dvh] min-h-[620px] overflow-hidden bg-[#f5f1ea] text-[#24302b]">
      <div className="mx-auto grid h-full w-full max-w-[1500px] lg:grid-cols-[0.92fr_1.08fr]">
        ...
        <main className="nfood-auth-main relative flex min-h-0 items-center justify-center overflow-y-auto px-4 py-5 sm:px-8 lg:overflow-hidden lg:px-14 xl:px-24">
          ...
          <div className="w-full max-w-[560px]">
            ...
            <div className="nfood-auth-card rounded-[2rem] border border-white/80 bg-white/85 p-5 shadow-[0_24px_80px_rgba(50,45,35,0.12)] backdrop-blur-xl sm:p-8 lg:max-h-[calc(100dvh-40px)] lg:overflow-y-auto">
