        ...
        <main className="flex items-center justify-center p-5 sm:p-8">
          ...
          <Card className="w-full max-w-xl rounded-[2rem] border-white/70 bg-white/90 shadow-[0_24px_80px_rgba(15,23,42,0.10)] backdrop-blur">
            <CardContent className="p-6 sm:p-10">
              ...
              <div className="mb-6 rounded-2xl border border-orange-200 bg-gradient-to-l from-orange-50 to-white p-4"><div className="flex items-start justify-between gap-3"><div><p className="text-sm font-black text-slate-900">{t("demoRestaurant")}</p><p className="mt-1 text-xs leading-5 text-slate-500">{t("demoRestaurantDescription")}</p></div><span className="rounded-full bg-orange-100 px-2.5 py-1 text-[10px] font-black text-orange-800">DEMO</span></div><Button type="button" variant="outline" onClick={() => { setEmail("restaurant-60001@nfood.local"); setPassword(""); }} className="mt-3 h-10 w-full rounded-xl border-orange-300 text-xs font-black text-orange-800 hover:bg-orange-100">{t("useDemoRestaurant")}</Button></div>
