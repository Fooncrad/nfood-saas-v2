...
export function BrandingEditorPanel({ restaurantId }: { restaurantId: number }) {
  ...
  const save = () => update.mutate({
    ...
    reservationNoShowGraceMinutes: query.data.reservationNoShowGraceMinutes, showBranchesOnMenu: query.data.showBranchesOnMenu, orderModesJson: JSON.stringify(orderModes),
  });
