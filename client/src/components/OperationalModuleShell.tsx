...
type OperationalModuleShellProps = { title: string; children: ReactNode };

export function OperationalModuleShell({ title, children }: OperationalModuleShellProps) {
  ...
  return <section ref={containerRef} className={isFullscreen ? "min-h-screen overflow-y-auto bg-slate-50 p-4 md:p-6" : "space-y-3"} aria-label={title}>
