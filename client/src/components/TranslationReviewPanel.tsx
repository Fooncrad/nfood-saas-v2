...
export function TranslationReviewPanel({ restaurantId }: { restaurantId: number }) {
  ...
  const addons = trpc.platform.menuItemAddons.useQuery({ restaurantId }, { retry: false });
