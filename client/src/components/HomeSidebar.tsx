  ...
  return (
    <TooltipProvider delayDuration={120}>
      <motion.aside
        ...
        className={`nfood-unified-sidebar fixed inset-y-0 z-20 hidden h-full overflow-hidden overscroll-contain border-white/10 bg-[#091321]/95 text-white shadow-[0_24px_80px_rgba(3,10,20,.42)] backdrop-blur-2xl lg:flex lg:flex-col start-0 ${direction === "rtl" ? "border-l" : "border-r"}`}
      >
