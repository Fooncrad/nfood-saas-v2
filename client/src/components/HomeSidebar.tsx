...
export function HomeSidebar({
  ...
  return (
    <aside data-sidebar-collapsed={sidebarCollapsed ? "true" : "false"} className={`nfood-unified-sidebar fixed inset-y-0 z-20 hidden h-full w-[304px] overflow-y-auto overscroll-contain border-slate-200 bg-[#111c2e] text-white lg:flex lg:flex-col ${direction === "rtl" ? "right-0 border-l" : "left-0 border-r"}`}>
      ...
      <div className="nfood-sidebar-body space-y-2 px-2.5 pb-2.5 pt-2.5">
