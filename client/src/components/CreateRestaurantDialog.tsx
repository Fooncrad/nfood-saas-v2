    ...
    <Dialog open={open} onOpenChange={(nextOpen) => { if (!nextOpen) onClose(); }}>
      <DialogContent dir="rtl" className="max-h-[90vh] overflow-y-auto rounded-3xl border-slate-200 bg-white p-5 shadow-2xl sm:max-w-lg sm:p-7">
        ...
        <div className="mt-2 space-y-4">
          ...
          <p className="rounded-xl border border-sky-100 bg-sky-50 px-3 py-2 text-[11px] leading-5 text-sky-800">تُعرض هذه الاختيارات كتهيئة أولية للنشاط، بينما تبقى مفاتيح الدفع والرسائل والتكاملات الخارجية غير مفعّلة حتى إدخال مفاتيحها من مركز البوابات.</p>
