      ...
      if (soundEnabled && typeof window !== "undefined") {
        try {
          ...
          if (AudioContextConstructor) {
            ...
            oscillator.frequency.value = nextEvent.type === "new" ? 880 : 660;
            gain.gain.setValueAtTime(0.0001, context.currentTime);
            gain.gain.exponentialRampToValueAtTime(Math.max(0.01, 0.12 * alertVolume), context.currentTime + 0.02);
          ...
          // Audio is an enhancement; visual alerts remain the source of truth.
        }
      }
