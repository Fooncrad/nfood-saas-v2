...
const menuTemplates: { key: StorefrontMenuTemplate; label: string; description: string; swatch: string }[] = [
  ...
  { key: "signature", label: "Signature", description: "هوية مميزة وتجربة راقية", swatch: "linear-gradient(135deg, #171717, #d6a85f)" },
];
        ...
        <CardContent className="grid gap-6 p-5 2xl:grid-cols-[minmax(0,1fr)_420px]">
          <div className="space-y-5">
            ...
            <section className="overflow-hidden rounded-3xl border border-slate-800 bg-slate-950 p-5 text-white shadow-xl">
              <div className="mb-5 flex flex-wrap items-end justify-between gap-3"><div><Badge className="mb-2 bg-orange-500 text-white">NFOOD Menu Studio</Badge><h3 className="text-lg font-black">اختر تجربة المنيو</h3><p className="mt-1 text-xs text-slate-400">5 قوالب متقدمة للبحث والتنقل السريع في أكثر من 500 صنف.</p></div><span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[10px] text-slate-300">500+ صنف جاهز</span></div>
