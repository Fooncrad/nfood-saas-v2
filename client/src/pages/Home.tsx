...
export default function Home() {
  ...
  const visibleNotifications = useMemo(() => (notificationsQuery.data ?? []).filter((item) => notificationPreferences[item.type] && (notificationFilter === "all" || !item.readAt)), [notificationFilter, notificationPreferences, notificationsQuery.data]);
