...
import { navItems, navTranslationKeys, statusLabels, statusStyles, type NavKey, type Order, type OrderStatus } from "@/components/homeNavigation";
...
export default function Home() {
  ...
  const remoteOrders = trpc.platform.ordersByRestaurant.useQuery({ restaurantId: selectedRestaurantId }, { enabled: workspaceReady && user?.role !== "admin" && (user?.testRole as string | undefined) !== "admin", retry: false, refetchInterval: 2000, refetchIntervalInBackground: true, refetchOnWindowFocus: true });
