...
export default function Home() {
  ...
  return (
    <div dir={direction} lang={language} className="min-h-screen bg-[#f6f7f9] nfood-dashboard-shell text-[#182230]">
      ...
      />
      <main className={direction === "rtl" ? "lg:mr-[272px]" : "lg:ml-[272px]"}>{user?.loginMethod === "admin_impersonation" && <button type="button" disabled={adminReturn.isPending} onClick={() => adminReturn.mutate()} className="fixed bottom-5 left-5 z-50 rounded-2xl bg-[#101d31] px-4 py-3 text-sm font-bold text-white shadow-xl hover:bg-[#17263d]">{adminReturn.isPending ? t("loading") : t("dashboard")}</button>}
