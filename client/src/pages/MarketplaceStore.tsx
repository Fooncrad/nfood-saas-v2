...
export default function MarketplaceStore() {
  ...
  const productImageRatio = entity?.sector === "restaurant" ? "aspect-square" : entity?.sector === "automotive" ? "aspect-[16/10]" : entity?.sector === "beauty_salon" || entity?.sector === "public_works" || entity?.sector === "laundry" ? "aspect-[4/3]" : "aspect-square";
  const productImageFit = "object-cover";
