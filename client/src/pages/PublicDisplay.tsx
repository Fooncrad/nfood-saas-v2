...
export default function PublicDisplay() {
  ...
  const continuousVideo = match ? "" : (slides.find((item) => Boolean(item?.externalVideoUrl))?.externalVideoUrl ?? displayVideo);
