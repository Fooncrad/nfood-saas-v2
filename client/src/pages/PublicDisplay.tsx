...
export default function PublicDisplay() {
  ...
  const layoutCount = activePlayback?.screen.displayLayout === "quad" ? 4 : activePlayback?.screen.displayLayout === "triple" ? 3 : activePlayback?.screen.displayLayout === "double" ? 2 : 1;
