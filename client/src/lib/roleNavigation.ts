export type DashboardNavKey = "overview" | "admin" | "accounts" | "settings" | "languages" | "files" | "branches" | "orders" | "pos" | "kds" | "menu" | "tables" | "qr" | "inventory" | "team" | "marketing" | "reservations" | "remote" | "security" | "health";
...
export const roleNavigation: Record<DashboardRole, DashboardNavKey[]> = {
  ...
  restaurant_admin: ["overview", "settings", "branches", "orders", "pos", "kds", "menu", "tables", "qr", "inventory", "team", "marketing", "reservations", "remote", "languages", "files", "security"],
