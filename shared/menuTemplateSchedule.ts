export type MenuTemplate = "editorial" | "bistro" | "glass" | "customer" | "market" | "signature";
...
const templateValues: MenuTemplate[] = ["editorial", "bistro", "glass", "customer", "market", "signature"];
